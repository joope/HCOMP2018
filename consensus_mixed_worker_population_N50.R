...
#First 5 workers are true experts, noise = 5%
for (i in 1:5) {
...
#Second part of 5 workers are experts, noise = 20%
for (i in 6:10) {
  nois = rbinom(N,1,0.2)
  lbs = mushrooms_Dexp$label
  lbs[mushrooms_Dexp$label==1 & nois]=2
...
#Third part of 15 workers are amateurs, noise = 40%
for (i in 11:25) {
  nois = rbinom(N,1,0.4)
  lbs = mushrooms_Dexp$label
  lbs[mushrooms_Dexp$label==1 & nois]=2
...
#Last fourth part of 25 workers are adversaries, 
